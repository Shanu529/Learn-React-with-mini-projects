...
function App() {
  ...
  return (
    <>
      <div className="bg-yellow-800 p-5 justify-center align-center ">
        <h2>this is counter of numbers {counter}</h2>

        <div className="text-blue-500 text-lg font-bold">Hello Tailwind!</div>

        

        <button onClick={addvalue} className="m-4">increase value {counter}</button>
        <button onClick={decrevalue}className="m-4">decrease value{counter}</button>
      </div>
    </>
  );
}
